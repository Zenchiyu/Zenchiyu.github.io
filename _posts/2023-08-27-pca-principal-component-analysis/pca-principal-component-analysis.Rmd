...
Because classification is a supervised learning task in which we have labeled data, dimensionality reduction techniques are therefore not fully reserved to unsupervised learning methods.
